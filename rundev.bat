@echo off
REM Batch file to build the project and run PDFToHTML

REM Step 1: Run Maven clean install
echo Running mvn clean install...
mvn clean install

REM Check if Maven build succeeded
if %errorlevel% neq 0 (
...
REM Step 2: Define the classpath
...
REM Step 3: Run the Java command
echo Running PDFToHTML...
