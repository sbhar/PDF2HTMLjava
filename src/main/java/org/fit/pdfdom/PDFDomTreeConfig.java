...
public class PDFDomTreeConfig
{
    ...
    private String testImgSrc;  // New field to store testImgSrc
    private String testHtmlOutput;  // New field to store testImgSrc
    ...
    // Getter and Setter for testImgSrc
    public String getTestImgSrc() {
        return testImgSrc;
    }

    public void setTestImgSrc(String testImgSrc) {
        //System.out.println("test in config: "+testImgSrc);
        this.testImgSrc = testImgSrc;
    }
    ...
    public void setTestHtmlOutput(String testHtmlOutput) {
        //System.out.println("test in config: "+testHtmlOutput);
        this.testHtmlOutput = testHtmlOutput;
    }
